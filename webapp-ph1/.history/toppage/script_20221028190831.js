...
// };
  ...
  function LanguageDoughnutChart(data){
    ...
    new Chart(context, {
      ...
      options:{
        backgroundColor:["#0000ff","#6495ed","#87cefa","#afeeee","#dda0dd","#da70d6","#ba55d3","#9966cc"],
        plugins:{
        //   htmlLegend: {
...
fetch(CONTENTS_DATA_URL)
  ...
  record_button.addEventListener('click',()=>{
    // checkbox.addEventListener('change',function(){
      if(checkbox.checked) { // ←重要なポイント！
        location.replace("https://twitter.com/compose/tweet?text=twitter_text.data");
        
      } else{
        // loader_display.classList.toggle('loader')
        const buttonOpen = document.getElementsByClassName('modalOpen');
